System.register(['@angular/http', 'angular2-in-memory-web-api', './services/in-memory-data.service', '@angular/platform-browser-dynamic', './app.component', './app.routes'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var http_1, angular2_in_memory_web_api_1, in_memory_data_service_1, platform_browser_dynamic_1, app_component_1, app_routes_1, http_2;
    return {
        setters:[
            function (http_1_1) {
                http_1 = http_1_1;
